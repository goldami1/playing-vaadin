...
public class AppLayout extends CompositeWrapperHorizontalLayout
{
	...
	private BodyMenuItem createBodyMenuItem(MENU_DESCRIPTOR menuDesc, Runnable toggleAction)
	{
		BodyMenuItem res = new BodyMenuItem(menuDesc.getIcon(), menuDesc.toString(), toggleAction);
	...
	private List<BodyMenuItem> createPluginsSubItems()
	{
		...
		res.add(createBodyMenuItem(MENU_DESCRIPTOR.LIBRARIES, () -> setContent(new GenericView(MENU_DESCRIPTOR.LIBRARIES.toString()))));
		res.add(createBodyMenuItem(MENU_DESCRIPTOR.COLLECTORS, () -> setContent(new GenericView(MENU_DESCRIPTOR.COLLECTORS.toString()))));
		res.add(createBodyMenuItem(MENU_DESCRIPTOR.TRANSFORMERS, () -> setContent(new GenericView(MENU_DESCRIPTOR.TRANSFORMERS.toString()))));
		res.add(createBodyMenuItem(MENU_DESCRIPTOR.ANALYSERS, () -> setContent(new GenericView(MENU_DESCRIPTOR.ANALYSERS.toString()))));
		res.add(createBodyMenuItem(MENU_DESCRIPTOR.NOTIFIERS, () -> setContent(new GenericView(MENU_DESCRIPTOR.NOTIFIERS.toString()))));
	...
	private List<BodyMenuItem> createTopologySubItems()
	{
		...
		BodyMenuItem remotes = createBodyMenuItem(MENU_DESCRIPTOR.REMOTES, () -> System.out.println("remotes"));
		remotes.addSubItem(new BodyMenuItem(VaadinIcon.BULLSEYE.create(), "Bullet1", () -> System.out.println("Bullet1")));
		remotes.addSubItem(new BodyMenuItem(VaadinIcon.BULLSEYE.create(), "Bullet2",() -> System.out.println("Bullet2")));
		remotes.addSubItem(new BodyMenuItem(VaadinIcon.BULLSEYE.create(), "Bullet3",() -> System.out.println("Bullet3")));
	...
	private Section createBodySection()
	{
		...
		BodyMenuItem homeMenuItem = createBodyMenuItem(MENU_DESCRIPTOR.HOME, () -> setContent(setDefaultView()));
		BodyMenuItem topologyMenuItem = createBodyMenuItem(MENU_DESCRIPTOR.TOPOLOGY, () -> System.out.println("Topology"));
	...
	private Component setDefaultView()
	{
